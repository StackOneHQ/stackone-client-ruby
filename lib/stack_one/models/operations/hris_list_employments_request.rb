  ...
  module Models
    module Operations
      ...
      class HrisListEmploymentsRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::HrisListEmploymentsQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
        # The unified cursor
        ...
        sig { params(x_account_id: ::String, prefer: T.nilable(::String), expand: T.nilable(::String), fields_: T.nilable(::String), filter: T.nilable(Models::Operations::HrisListEmploymentsQueryParamFilter), next_: T.nilable(::String), page: T.nilable(::String), page_size: T.nilable(::String), proxy: T.nilable(T::Hash[Symbol, ::Object]), raw: T.nilable(T::Boolean), updated_after: T.nilable(::DateTime)).void }
        def initialize(x_account_id:, prefer: nil, expand: nil, fields_: nil, filter: nil, next_: nil, page: nil, page_size: nil, proxy: nil, raw: nil, updated_after: nil)
