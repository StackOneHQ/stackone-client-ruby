...
module StackOne
  module Operations
    ...
    class AtsGetApplicationScorecardResponse < ::Crystalline::FieldAugmented
      ...
      sig { params(content_type: ::String, headers: T::Hash[Symbol, T::Array[::String]], raw_response: ::Faraday::Response, status_code: ::Integer, scorecards_result: T.nilable(::StackOne::Shared::ScorecardsResult)).void }
