  ...
  module Models
    module Operations
      ...
      class HrisCreateEmployeeTimeOffRequestRequest
        ...
        sig { params(hris_create_time_off_request_dto: Models::Shared::HrisCreateTimeOffRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(hris_create_time_off_request_dto:, id:, x_account_id:, prefer: nil)
