...
module StackOne
  module Operations
    ...
    class AtsListCandidateCustomFieldDefinitionsRequest < ::StackOne::Utils::FieldAugmented
      extend T::Sig
      ...
      field :filter, T.nilable(::StackOne::Operations::AtsListCandidateCustomFieldDefinitionsQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
      # The unified cursor
