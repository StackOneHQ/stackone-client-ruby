  ...
  module Models
    module Operations
      ...
      class AtsListApplicationsRequest
        ...
        def initialize(x_account_id:, expand: nil, fields_: nil, filter: nil, include: nil, job_id: nil, next_: nil, page: nil, page_size: nil, proxy: nil, raw: nil, sync_token: nil, updated_after: nil)
