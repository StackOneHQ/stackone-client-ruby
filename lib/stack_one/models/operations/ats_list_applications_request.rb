  ...
  module Models
    module Operations
      ...
      class AtsListApplicationsRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::AtsListApplicationsQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
        ...
        sig { params(x_account_id: ::String, prefer: T.nilable(::String), expand: T.nilable(::String), fields_: T.nilable(::String), filter: T.nilable(Models::Operations::AtsListApplicationsQueryParamFilter), include: T.nilable(::String), job_id: T.nilable(::String), next_: T.nilable(::String), page: T.nilable(::String), page_size: T.nilable(::String), proxy: T.nilable(T::Hash[Symbol, ::Object]), raw: T.nilable(T::Boolean), sync_token: T.nilable(::String), updated_after: T.nilable(::DateTime)).void }
        def initialize(x_account_id:, prefer: nil, expand: nil, fields_: nil, filter: nil, include: nil, job_id: nil, next_: nil, page: nil, page_size: nil, proxy: nil, raw: nil, sync_token: nil, updated_after: nil)
