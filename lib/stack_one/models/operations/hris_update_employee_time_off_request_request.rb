  ...
  module Models
    module Operations
      ...
      class HrisUpdateEmployeeTimeOffRequestRequest
        ...
        sig { params(hris_create_time_off_request_dto: Models::Shared::HrisCreateTimeOffRequestDto, id: ::String, sub_resource_id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(hris_create_time_off_request_dto:, id:, sub_resource_id:, x_account_id:, prefer: nil)
