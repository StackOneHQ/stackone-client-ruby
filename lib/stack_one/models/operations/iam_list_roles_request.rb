...
module StackOne
  module Operations
    ...
    class IamListRolesRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :filter, T.nilable(::StackOne::Operations::IamListRolesQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
      # The unified cursor
