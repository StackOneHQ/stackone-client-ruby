  ...
  module Models
    module Operations
      ...
      class AtsListBackgroundCheckPackagesRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::AtsListBackgroundCheckPackagesQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'form', 'explode': true } }
        # The unified cursor
