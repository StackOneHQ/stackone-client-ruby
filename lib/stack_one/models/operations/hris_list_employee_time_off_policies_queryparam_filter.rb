  ...
  module Models
    module Operations
      ...
      class HrisListEmployeeTimeOffPoliciesQueryParamFilter
        ...
        field :type, Crystalline::Nilable.new(Models::Operations::Type), { 'query_param': { 'field_name': 'type' } }
        # Use a string with a date to only select results updated after that given date
        field :updated_after, Crystalline::Nilable.new(::DateTime), { 'query_param': { 'field_name': 'updated_after' } }

        sig { params(type: T.nilable(Models::Operations::Type), updated_after: T.nilable(::DateTime)).void }
