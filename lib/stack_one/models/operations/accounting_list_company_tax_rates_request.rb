  ...
  module Models
    module Operations
      ...
      class AccountingListCompanyTaxRatesRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::AccountingListCompanyTaxRatesQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
        # The unified cursor
