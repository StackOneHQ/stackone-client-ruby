  ...
  module Models
    module Operations
      ...
      class AtsCreateCandidateRequest
        ...
        sig { params(ats_create_candidate_request_dto: Models::Shared::AtsCreateCandidateRequestDto, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(ats_create_candidate_request_dto:, x_account_id:, prefer: nil)
