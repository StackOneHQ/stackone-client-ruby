  ...
  module Models
    module Operations
      ...
      class AtsListApplicationChangesRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::AtsListApplicationChangesQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
        # The unified cursor
        ...
        sig { params(id: ::String, x_account_id: ::String, prefer: T.nilable(::String), fields_: T.nilable(::String), filter: T.nilable(Models::Operations::AtsListApplicationChangesQueryParamFilter), next_: T.nilable(::String), page_size: T.nilable(::String), proxy: T.nilable(T::Hash[Symbol, ::Object]), raw: T.nilable(T::Boolean)).void }
        def initialize(id:, x_account_id:, prefer: nil, fields_: nil, filter: nil, next_: nil, page_size: nil, proxy: nil, raw: nil)
          @id = id
