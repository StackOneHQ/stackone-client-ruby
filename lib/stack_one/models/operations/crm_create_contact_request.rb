  ...
  module Models
    module Operations
      ...
      class CrmCreateContactRequest
        ...
        sig { params(crm_create_contact_request_dto: Models::Shared::CrmCreateContactRequestDto, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(crm_create_contact_request_dto:, x_account_id:, prefer: nil)
