  ...
  module Models
    module Operations
      ...
      class CrmGetContactRequest
        ...
        sig { params(id: ::String, x_account_id: ::String, prefer: T.nilable(::String), fields_: T.nilable(::String), include: T.nilable(::String), proxy: T.nilable(T::Hash[Symbol, ::Object]), raw: T.nilable(T::Boolean)).void }
        def initialize(id:, x_account_id:, prefer: nil, fields_: nil, include: nil, proxy: nil, raw: nil)
          @id = id
