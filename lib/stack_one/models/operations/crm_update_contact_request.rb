  ...
  module Models
    module Operations
      ...
      class CrmUpdateContactRequest
        ...
        sig { params(crm_create_contact_request_dto: Models::Shared::CrmCreateContactRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(crm_create_contact_request_dto:, id:, x_account_id:, prefer: nil)
