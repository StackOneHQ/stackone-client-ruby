  ...
  module Models
    module Operations
      ...
      class AtsListApplicationDocumentCategoriesRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::AtsListApplicationDocumentCategoriesQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
        # The unified cursor
