...
module StackOne
  module Operations
    ...
    class AtsGetCandidateCustomFieldDefinitionRequest < ::Crystalline::FieldAugmented
      ...
      field :filter, T.nilable(::StackOne::Operations::AtsGetCandidateCustomFieldDefinitionQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
      # The unified cursor
