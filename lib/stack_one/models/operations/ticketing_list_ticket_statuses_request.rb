  ...
  module Models
    module Operations
      ...
      class TicketingListTicketStatusesRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::TicketingListTicketStatusesQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
        # The unified cursor
