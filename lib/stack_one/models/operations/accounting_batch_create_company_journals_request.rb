  ...
  module Models
    module Operations
      ...
      class AccountingBatchCreateCompanyJournalsRequest
        ...
        sig { params(accounting_journal_batch_create_request_dto: Models::Shared::AccountingJournalBatchCreateRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(accounting_journal_batch_create_request_dto:, id:, x_account_id:, prefer: nil)
