...
module StackOne
  module Operations
    ...
    class HrisListCostCenterGroupsResponse < ::Crystalline::FieldAugmented
      ...
      sig { params(content_type: ::String, headers: T::Hash[Symbol, T::Array[::String]], raw_response: ::Faraday::Response, status_code: ::Integer, hris_cost_center_paginated: T.nilable(::StackOne::Shared::HRISCostCenterPaginated)).void }
