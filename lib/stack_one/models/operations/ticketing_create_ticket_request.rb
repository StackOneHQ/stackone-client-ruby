  ...
  module Models
    module Operations
      ...
      class TicketingCreateTicketRequest
        ...
        sig { params(ticketing_ticket_create_request_dto: Models::Shared::TicketingTicketCreateRequestDto, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(ticketing_ticket_create_request_dto:, x_account_id:, prefer: nil)
