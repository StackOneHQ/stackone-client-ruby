  ...
  module Models
    module Operations
      ...
      class MarketingListOmniChannelTemplatesRequest
        ...
        field :filter, T.nilable(Models::Operations::MarketingListOmniChannelTemplatesQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
        # The unified cursor
