...
module StackOne
  module Operations
    ...
    class StackoneListStepLogsResponse < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :step_logs_paginated, T.nilable(::StackOne::Shared::StepLogsPaginated)
      # Too many requests.
