  ...
  module Models
    module Operations
      ...
      class LmsCreateUserAssignmentRequest
        ...
        sig { params(lms_create_assignment_request_dto: Models::Shared::LmsCreateAssignmentRequestDto, id: ::String, x_account_id: ::String).void }
        def initialize(lms_create_assignment_request_dto:, id:, x_account_id:)
