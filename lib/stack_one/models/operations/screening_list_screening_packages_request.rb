  ...
  module Models
    module Operations
      ...
      class ScreeningListScreeningPackagesRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::ScreeningListScreeningPackagesQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'form', 'explode': true } }
        # The unified cursor
