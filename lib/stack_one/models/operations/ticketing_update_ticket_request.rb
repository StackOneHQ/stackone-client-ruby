  ...
  module Models
    module Operations
      ...
      class TicketingUpdateTicketRequest
        ...
        sig { params(ticketing_ticket_update_request_dto: Models::Shared::TicketingTicketUpdateRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(ticketing_ticket_update_request_dto:, id:, x_account_id:, prefer: nil)
