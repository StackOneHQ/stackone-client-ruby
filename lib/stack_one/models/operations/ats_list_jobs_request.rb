  ...
  module Models
    module Operations
      ...
      class AtsListJobsRequest
        ...
        # ATS Jobs filters
        field :filter, Crystalline::Nilable.new(Models::Operations::AtsListJobsQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
