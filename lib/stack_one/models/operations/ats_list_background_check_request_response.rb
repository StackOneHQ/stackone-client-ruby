...
module StackOne
  module Operations
    ...
    class AtsListBackgroundCheckRequestResponse < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :background_check_order_paginated, T.nilable(::StackOne::Shared::BackgroundCheckOrderPaginated)
      # Bad gateway error.
