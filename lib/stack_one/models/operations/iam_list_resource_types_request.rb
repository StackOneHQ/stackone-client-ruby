...
module StackOne
  module Models
    module Operations
      ...
      class IamListResourceTypesRequest
        extend T::Sig
        ...
        sig { params(x_account_id: ::String, prefer: T.nilable(::String), fields_: T.nilable(::String), proxy: T.nilable(T::Hash[Symbol, ::Object]), raw: T.nilable(T::Boolean)).void }
