  ...
  module Models
    module Operations
      ...
      class IamGetGroupRequest
        ...
        sig { params(id: ::String, x_account_id: ::String, prefer: T.nilable(::String), expand: T.nilable(::String), fields_: T.nilable(::String), proxy: T.nilable(T::Hash[Symbol, ::Object]), raw: T.nilable(T::Boolean)).void }
        def initialize(id:, x_account_id:, prefer: nil, expand: nil, fields_: nil, proxy: nil, raw: nil)
          @id = id
