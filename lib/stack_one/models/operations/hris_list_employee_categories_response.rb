...
module StackOne
  module Operations
    ...
    class HrisListEmployeeCategoriesResponse < ::Crystalline::FieldAugmented
      ...
      sig { params(content_type: ::String, headers: T::Hash[Symbol, T::Array[::String]], raw_response: ::Faraday::Response, status_code: ::Integer, reference_paginated: T.nilable(::StackOne::Shared::ReferencePaginated)).void }
