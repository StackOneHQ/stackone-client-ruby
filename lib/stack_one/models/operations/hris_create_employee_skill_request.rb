  ...
  module Models
    module Operations
      ...
      class HrisCreateEmployeeSkillRequest
        ...
        sig { params(entity_skills_create_request_dto: Models::Shared::EntitySkillsCreateRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(entity_skills_create_request_dto:, id:, x_account_id:, prefer: nil)
