  ...
  module Models
    module Operations
      ...
      class LmsListUserCompletionsRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::LmsListUserCompletionsQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'form', 'explode': true } }
        # The unified cursor
