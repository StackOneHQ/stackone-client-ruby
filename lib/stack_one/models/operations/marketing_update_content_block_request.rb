  ...
  module Models
    module Operations
      ...
      class MarketingUpdateContentBlockRequest
        ...
        sig { params(marketing_create_content_blocks_request_dto: Models::Shared::MarketingCreateContentBlocksRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(marketing_create_content_blocks_request_dto:, id:, x_account_id:, prefer: nil)
