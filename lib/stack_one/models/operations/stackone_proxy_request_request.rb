  ...
  module Models
    module Operations
      ...
      class StackoneProxyRequestRequest
        ...
        sig { params(proxy_request_body: Models::Shared::ProxyRequestBody, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(proxy_request_body:, x_account_id:, prefer: nil)
