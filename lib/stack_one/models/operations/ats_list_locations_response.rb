...
module StackOne
  module Operations
    ...
    class AtsListLocationsResponse < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :ats_locations_paginated, T.nilable(::StackOne::Shared::ATSLocationsPaginated)
      # Bad gateway error.
