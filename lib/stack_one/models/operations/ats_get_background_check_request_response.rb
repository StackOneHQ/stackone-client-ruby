...
module StackOne
  module Operations
    ...
    class AtsGetBackgroundCheckRequestResponse < ::Crystalline::FieldAugmented
      ...
      sig { params(content_type: ::String, headers: T::Hash[Symbol, T::Array[::String]], raw_response: ::Faraday::Response, status_code: ::Integer, background_check_order_result: T.nilable(::StackOne::Shared::BackgroundCheckOrderResult)).void }
