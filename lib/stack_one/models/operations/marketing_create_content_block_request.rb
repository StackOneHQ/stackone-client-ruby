  ...
  module Models
    module Operations
      ...
      class MarketingCreateContentBlockRequest
        ...
        sig { params(marketing_create_content_blocks_request_dto: Models::Shared::MarketingCreateContentBlocksRequestDto, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(marketing_create_content_blocks_request_dto:, x_account_id:, prefer: nil)
