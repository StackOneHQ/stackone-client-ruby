  ...
  module Models
    module Operations
      ...
      class HrisUpdateEmployeeEmploymentRequest
        ...
        sig { params(hris_update_employment_request_dto: Models::Shared::HrisUpdateEmploymentRequestDto, id: ::String, sub_resource_id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(hris_update_employment_request_dto:, id:, sub_resource_id:, x_account_id:, prefer: nil)
