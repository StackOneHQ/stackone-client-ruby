  ...
  module Models
    module Operations
      ...
      class HrisUpdateEmployeeRequest
        ...
        sig { params(hris_update_employee_request_dto: Models::Shared::HrisUpdateEmployeeRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(hris_update_employee_request_dto:, id:, x_account_id:, prefer: nil)
