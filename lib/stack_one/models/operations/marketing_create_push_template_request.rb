  ...
  module Models
    module Operations
      ...
      class MarketingCreatePushTemplateRequest
        ...
        sig { params(marketing_create_push_template_request_dto: Models::Shared::MarketingCreatePushTemplateRequestDto, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(marketing_create_push_template_request_dto:, x_account_id:, prefer: nil)
