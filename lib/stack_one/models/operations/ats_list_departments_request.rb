  ...
  module Models
    module Operations
      ...
      class AtsListDepartmentsRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::AtsListDepartmentsQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
        # The unified cursor
        ...
        sig { params(x_account_id: ::String, prefer: T.nilable(::String), fields_: T.nilable(::String), filter: T.nilable(Models::Operations::AtsListDepartmentsQueryParamFilter), next_: T.nilable(::String), page: T.nilable(::String), page_size: T.nilable(::String), proxy: T.nilable(T::Hash[Symbol, ::Object]), raw: T.nilable(T::Boolean), sync_token: T.nilable(::String), updated_after: T.nilable(::DateTime)).void }
