  ...
  module Models
    module Operations
      ...
      class MarketingUpdatePushTemplateRequest
        ...
        sig { params(marketing_create_push_template_request_dto: Models::Shared::MarketingCreatePushTemplateRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(marketing_create_push_template_request_dto:, id:, x_account_id:, prefer: nil)
