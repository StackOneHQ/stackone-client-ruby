  ...
  module Models
    module Operations
      ...
      class AtsCreateCandidateNoteRequest
        ...
        sig { params(ats_create_notes_request_dto: Models::Shared::AtsCreateNotesRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(ats_create_notes_request_dto:, id:, x_account_id:, prefer: nil)
