...
module StackOne
  module Operations
    ...
    class IamListRolesResponse < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :iam_roles_paginated, T.nilable(::StackOne::Shared::IamRolesPaginated)
