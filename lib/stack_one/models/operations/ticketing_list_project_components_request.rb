  ...
  module Models
    module Operations
      ...
      class TicketingListProjectComponentsRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::TicketingListProjectComponentsQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
        # The unified cursor
