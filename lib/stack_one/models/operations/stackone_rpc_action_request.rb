  ...
  module Models
    module Operations
      ...
      class StackoneRpcActionRequest
        ...
        sig { params(actions_rpc_request_dto: Models::Shared::ActionsRpcRequestDto, x_account_id: ::String, x_connector_profile_id: T.nilable(::String), debug: T.nilable(T::Boolean), sync: T.nilable(T::Boolean)).void }
        def initialize(actions_rpc_request_dto:, x_account_id:, x_connector_profile_id: nil, debug: nil, sync: nil)
