  ...
  module Models
    module Operations
      ...
      class HrisCreateEmployeeEmploymentRequest
        ...
        sig { params(hris_create_employment_request_dto: Models::Shared::HrisCreateEmploymentRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(hris_create_employment_request_dto:, id:, x_account_id:, prefer: nil)
