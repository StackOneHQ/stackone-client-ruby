  ...
  module Models
    module Operations
      ...
      class HrisListEmployeeWorkEligibilityRequest
        ...
        field :filter, Crystalline::Nilable.new(Models::Operations::HrisListEmployeeWorkEligibilityQueryParamFilter), { 'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': true } }
        # The unified cursor
