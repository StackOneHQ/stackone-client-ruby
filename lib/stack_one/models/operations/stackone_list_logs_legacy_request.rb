...
module StackOne
  module Models
    module Operations
      ...
      class StackoneListLogsLegacyRequest
        extend T::Sig
        ...
        field :include, Crystalline::Nilable.new(Models::Operations::StackoneListLogsLegacyQueryParamInclude), { 'query_param': { 'field_name': 'include', 'style': 'form', 'explode': true } }
        # The unified cursor
        ...
        sig { params(filter: T.nilable(Models::Operations::QueryParamFilter), include: T.nilable(Models::Operations::StackoneListLogsLegacyQueryParamInclude), next_: T.nilable(::String), order_by: T.nilable(Models::Operations::OrderBy), order_direction: T.nilable(Models::Operations::OrderDirection), page_size: T.nilable(::Float)).void }
