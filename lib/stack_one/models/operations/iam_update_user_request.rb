  ...
  module Models
    module Operations
      ...
      class IamUpdateUserRequest
        ...
        sig { params(iam_update_user_request_dto: Models::Shared::IamUpdateUserRequestDto, id: ::String, x_account_id: ::String, prefer: T.nilable(::String)).void }
        def initialize(iam_update_user_request_dto:, id:, x_account_id:, prefer: nil)
