  ...
  module Models
    module Shared
      ...
      class AtsUpdateCandidatesAssessmentsResultsRequestDto
        ...
        field :candidate, Crystalline::Nilable.new(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoCandidate), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('candidate') } }
        ...
        field :result, Crystalline::Nilable.new(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoResult), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('result') } }
        ...
        sig { params(attachments: T.nilable(T::Array[Models::Shared::Attachment]), candidate: T.nilable(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoCandidate), passthrough: T.nilable(T::Hash[Symbol, ::Object]), result: T.nilable(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoResult), result_url: T.nilable(::String), score: T.nilable(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoScore), start_date: T.nilable(::DateTime), submission_date: T.nilable(::DateTime), summary: T.nilable(::String)).void }
