  ...
  module Models
    module Shared
      ...
      class AtsUpdateCandidatesAssessmentsResultsRequestDto
        ...
        field :candidate, T.nilable(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoCandidate), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('candidate') } }
        # Unique identifier
        field :id, T.nilable(::String), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('id') } }
        # Value to pass through to the provider
        field :passthrough, T.nilable(T::Hash[Symbol, ::Object]), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('passthrough') } }

        field :result, T.nilable(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoResult), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('result') } }
        # The test`s result url
        field :result_url, T.nilable(::String), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('result_url') } }

        field :score, T.nilable(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoScore), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('score') } }
        ...
        sig { params(attachments: T.nilable(T::Array[Models::Shared::Attachment]), candidate: T.nilable(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoCandidate), id: T.nilable(::String), passthrough: T.nilable(T::Hash[Symbol, ::Object]), result: T.nilable(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoResult), result_url: T.nilable(::String), score: T.nilable(Models::Shared::AtsUpdateCandidatesAssessmentsResultsRequestDtoScore), start_date: T.nilable(::DateTime), submission_date: T.nilable(::DateTime), summary: T.nilable(::String)).void }
