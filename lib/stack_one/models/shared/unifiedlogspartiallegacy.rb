...
module StackOne
  module Models
    module Shared
      ...
      class UnifiedLogsPartialLegacy
        extend T::Sig
        ...
        field :step_requests, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::StepLogPartialLegacy)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('step_requests') } }
