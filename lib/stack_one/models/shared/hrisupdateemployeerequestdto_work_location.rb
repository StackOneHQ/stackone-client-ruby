...
module StackOne
  module Shared
    ...
    class HrisUpdateEmployeeRequestDtoWorkLocation < ::StackOne::Utils::FieldAugmented
      ...
      # The country code
      field :country, T.nilable(::StackOne::Shared::HrisUpdateEmployeeRequestDtoSchemasWorkLocationCountry), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('country') } }
      # Unique identifier
      ...
      field :state, T.nilable(::StackOne::Shared::HrisUpdateEmployeeRequestDtoSchemasState), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('state') } }
