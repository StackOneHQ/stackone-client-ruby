...
module StackOne
  module Shared
    ...
    class LmsCreateCompletionRequestDto < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(completed_at: T.nilable(::String), content_external_reference: T.nilable(::String), content_id: T.nilable(::String), external_id: T.nilable(::String), external_reference: T.nilable(::String), learning_object_external_reference: T.nilable(::String), learning_object_id: T.nilable(::String), passthrough: T.nilable(T::Hash[Symbol, ::Object]), result: T.nilable(::StackOne::Shared::LmsCreateCompletionRequestDtoResult)).void }
      def initialize(completed_at: nil, content_external_reference: nil, content_id: nil, external_id: nil, external_reference: nil, learning_object_external_reference: nil, learning_object_id: nil, passthrough: nil, result: nil)
