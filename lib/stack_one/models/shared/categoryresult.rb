...
module StackOne
  module Shared
    ...
    class CategoryResult < ::Crystalline::FieldAugmented
      ...
      field :data, ::StackOne::Shared::Category, { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }

      field :raw, T.nilable(T::Array[::StackOne::Shared::RawResponse]), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('raw') } }


      sig { params(data: ::StackOne::Shared::Category, raw: T.nilable(T::Array[::StackOne::Shared::RawResponse])).void }
