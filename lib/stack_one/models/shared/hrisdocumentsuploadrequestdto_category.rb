  ...
  module Models
    module Shared
      ...
      class HrisDocumentsUploadRequestDtoCategory
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::HrisDocumentsUploadRequestDtoValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::HrisDocumentsUploadRequestDtoValue, true) } }
