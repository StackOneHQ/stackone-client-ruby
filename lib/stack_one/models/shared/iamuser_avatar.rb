  ...
  module Models
    module Shared
      ...
      class IamUserAvatar
        ...
        field :category, T.nilable(Models::Shared::IamUserCategory), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('category') } }
        ...
        field :file_format, T.nilable(Models::Shared::IamUserFileFormat), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('file_format') } }
        # Unique identifier
        ...
        sig { params(category: T.nilable(Models::Shared::IamUserCategory), category_id: T.nilable(::String), contents: T.nilable(T::Array[Models::Shared::Content]), created_at: T.nilable(::DateTime), file_format: T.nilable(Models::Shared::IamUserFileFormat), id: T.nilable(::String), name: T.nilable(::String), path: T.nilable(::String), remote_id: T.nilable(::String), remote_url: T.nilable(::String), updated_at: T.nilable(::DateTime)).void }
