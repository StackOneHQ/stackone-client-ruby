  ...
  module Models
    module Shared
      ...
      class HrisUpdateEmployeeRequestDtoSchemasEmploymentType
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::HrisUpdateEmployeeRequestDtoSchemasEmploymentEmploymentTypeValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::HrisUpdateEmployeeRequestDtoSchemasEmploymentEmploymentTypeValue, true) } }
