  ...
  module Models
    module Shared
      ...
      class UnifiedLogsPartial
        ...
        field :step_requests, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::StepLogPartial)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('step_requests') } }
