...
module StackOne
  module Shared
    ...
    class IamUsersPaginated < ::Crystalline::FieldAugmented
      ...
      field :data, T::Array[::StackOne::Shared::IamUser], { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }
      ...
      sig { params(data: T::Array[::StackOne::Shared::IamUser], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[::StackOne::Shared::RawResponse])).void }
