  ...
  module Models
    module Shared
      ...
      class Note
        ...
        # Date of Deletion
        field :deleted_at, Crystalline::Nilable.new(::DateTime), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('deleted_at'), 'decoder': ::StackOne::Utils.datetime_from_iso_format(true) } }
        # Unique identifier
