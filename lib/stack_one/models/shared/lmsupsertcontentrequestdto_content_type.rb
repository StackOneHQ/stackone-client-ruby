  ...
  module Models
    module Shared
      ...
      class LmsUpsertContentRequestDtoContentType
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::LmsUpsertContentRequestDtoValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::LmsUpsertContentRequestDtoValue, true) } }
