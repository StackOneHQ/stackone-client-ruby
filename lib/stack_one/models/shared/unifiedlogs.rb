...
module StackOne
  module Shared
    ...
    class UnifiedLogs < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :request, T.nilable(::StackOne::Shared::UnifiedLogsRequest), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('request') } }
      # The request ID
      ...
      field :response, T.nilable(::StackOne::Shared::UnifiedLogsResponse), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('response') } }
      ...
      sig { params(account_id: T.nilable(::String), action: T.nilable(::String), child_resource: T.nilable(::String), duration: T.nilable(::Float), end_time: T.nilable(::DateTime), event_datetime: T.nilable(::DateTime), http_method: T.nilable(::String), is_worker: T.nilable(T::Boolean), path: T.nilable(::String), project_id: T.nilable(::String), provider: T.nilable(::String), request: T.nilable(::StackOne::Shared::UnifiedLogsRequest), request_id: T.nilable(::String), resource: T.nilable(::String), response: T.nilable(::StackOne::Shared::UnifiedLogsResponse), service: T.nilable(::String), source_id: T.nilable(::String), source_type: T.nilable(::String), source_value: T.nilable(::String), start_time: T.nilable(::DateTime), status: T.nilable(::Float), step_requests: T.nilable(T::Array[::String]), sub_resource: T.nilable(::String), success: T.nilable(T::Boolean), url: T.nilable(::String)).void }
