  ...
  module Models
    module Shared
      ...
      class UnifiedLogs
        ...
        field :request, Crystalline::Nilable.new(Models::Shared::UnifiedLogsRequest), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('request') } }
        # The request ID
        ...
        field :response, Crystalline::Nilable.new(Models::Shared::UnifiedLogsResponse), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('response') } }
