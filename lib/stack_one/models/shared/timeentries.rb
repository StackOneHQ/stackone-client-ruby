  ...
  module Models
    module Shared
      ...
      class TimeEntries
        ...
        field :labor_type, T.nilable(Models::Shared::LaborType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('labor_type') } }
        # The location of the time entry
        field :location, T.nilable(Models::Shared::Location), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('location') } }
        ...
        field :status, T.nilable(Models::Shared::TimeEntriesStatus), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('status') } }
