  ...
  module Models
    module Shared
      ...
      class HrisCreateEmployeeRequestDtoWorkLocation
        ...
        # The country code
        field :country, T.nilable(Models::Shared::HrisCreateEmployeeRequestDtoSchemasWorkLocationCountry), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('country') } }
        # Unique identifier
        ...
        field :state, T.nilable(Models::Shared::HrisCreateEmployeeRequestDtoState), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('state') } }
