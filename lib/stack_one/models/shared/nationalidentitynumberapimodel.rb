  ...
  module Models
    module Shared
      ...
      class NationalIdentityNumberApiModel
        ...
        # The country code
        field :country, Crystalline::Nilable.new(Models::Shared::NationalIdentityNumberApiModelCountry), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('country') } }

        field :type, Crystalline::Nilable.new(Models::Shared::NationalIdentityNumberApiModelType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('type') } }
