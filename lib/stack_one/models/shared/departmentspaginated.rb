  ...
  module Models
    module Shared
      ...
      class DepartmentsPaginated
        ...
        field :data, Crystalline::Array.new(Models::Shared::Department), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        sig { params(data: T::Array[Models::Shared::Department], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
