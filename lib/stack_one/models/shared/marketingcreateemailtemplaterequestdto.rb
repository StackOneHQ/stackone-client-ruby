  ...
  module Models
    module Shared
      ...
      class MarketingCreateEmailTemplateRequestDto
        ...
        sig { params(messages: T.nilable(T::Array[Models::Shared::EmailMessages]), name: T.nilable(::String), passthrough: T.nilable(T::Hash[Symbol, ::Object]), tags: T.nilable(T::Array[::String])).void }
