  ...
  module Models
    module Shared
      ...
      class HrisCreateEmployeeRequestDtoHomeLocation
        ...
        # The country code
        field :country, Crystalline::Nilable.new(Models::Shared::HrisCreateEmployeeRequestDtoCountry), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('country') } }
        # Unique identifier
        ...
        field :state, Crystalline::Nilable.new(Models::Shared::State), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('state') } }
        ...
        sig { params(city: T.nilable(::String), country: T.nilable(Models::Shared::HrisCreateEmployeeRequestDtoCountry), id: T.nilable(::String), name: T.nilable(::String), passthrough: T.nilable(T::Hash[Symbol, ::Object]), phone_number: T.nilable(::String), state: T.nilable(Models::Shared::State), street_1: T.nilable(::String), street_2: T.nilable(::String), zip_code: T.nilable(::String)).void }
