  ...
  module Models
    module Shared
      ...
      class HrisCreateEmployeeRequestDtoHomeLocation
        ...
        # The country code
        field :country, T.nilable(Models::Shared::HrisCreateEmployeeRequestDtoCountry), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('country') } }
        # Unique identifier
        ...
        field :state, T.nilable(Models::Shared::State), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('state') } }
