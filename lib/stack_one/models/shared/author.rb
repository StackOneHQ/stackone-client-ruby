  ...
  module Models
    module Shared
      ...
      class Author
        ...
        field :active, Crystalline::Nilable.new(Crystalline::Union.new(Crystalline::Boolean.new, Models::Shared::MessagingMessage2)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('active') } }
        # The created_at date
        ...
        sig { params(active: T.nilable(T.any(T::Boolean, Models::Shared::MessagingMessage2)), created_at: T.nilable(::DateTime), email: T.nilable(::String), external_reference: T.nilable(::String), id: T.nilable(::String), name: T.nilable(::String), phone_number: T.nilable(::String), remote_id: T.nilable(::String), unified_custom_fields: T.nilable(T::Hash[Symbol, ::Object]), updated_at: T.nilable(::DateTime)).void }
