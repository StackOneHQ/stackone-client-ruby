  ...
  module Models
    module Shared
      ...
      class CreateSkillsApiModelHierarchy
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::CreateSkillsApiModelValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::CreateSkillsApiModelValue, true) } }
