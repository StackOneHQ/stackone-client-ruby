  ...
  module Models
    module Shared
      ...
      class AccountingJournal
        ...
        field :lines, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::JournalLine)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('lines') } }
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::Status), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('status') } }
        ...
        sig { params(company_id: T.nilable(::String), created_at: T.nilable(::DateTime), id: T.nilable(::String), lines: T.nilable(T::Array[Models::Shared::JournalLine]), memo: T.nilable(::String), posted_at: T.nilable(::DateTime), reference: T.nilable(::String), remote_id: T.nilable(::String), status: T.nilable(Models::Shared::Status), transaction_date: T.nilable(::DateTime), updated_at: T.nilable(::DateTime)).void }
