...
module StackOne
  module Shared
    ...
    class NoteResult < ::Crystalline::FieldAugmented
      ...
      field :data, ::StackOne::Shared::Note, { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }

      field :raw, T.nilable(T::Array[::StackOne::Shared::RawResponse]), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('raw') } }


      sig { params(data: ::StackOne::Shared::Note, raw: T.nilable(T::Array[::StackOne::Shared::RawResponse])).void }
