  ...
  module Models
    module Shared
      ...
      class JobsPaginated
        ...
        field :data, T::Array[Models::Shared::Job], { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }
        ...
        sig { params(data: T::Array[Models::Shared::Job], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
