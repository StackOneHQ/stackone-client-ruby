...
module StackOne
  module Shared
    ...
    class BackgroundCheckOrderPackage < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(description: T.nilable(::String), id: T.nilable(::String), name: T.nilable(::String), remote_id: T.nilable(::String), tests: T.nilable(T::Array[::StackOne::Shared::AssessmentsPackagesTestApiModel])).void }
