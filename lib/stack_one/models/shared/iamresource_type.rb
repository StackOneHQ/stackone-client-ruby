  ...
  module Models
    module Shared
      ...
      class IamResourceType
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::IamResourceValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': Utils.enum_from_string(Models::Shared::IamResourceValue, true) } }
