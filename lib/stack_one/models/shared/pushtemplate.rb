  ...
  module Models
    module Shared
      ...
      class PushTemplate
        ...
        sig { params(created_at: T.nilable(::DateTime), id: T.nilable(::String), messages: T.nilable(T::Array[Models::Shared::PushMessages]), name: T.nilable(::String), remote_id: T.nilable(::String), tags: T.nilable(T::Array[::String]), updated_at: T.nilable(::DateTime)).void }
