  ...
  module Models
    module Shared
      ...
      class HrisUpdateEmployeeRequestDtoEmployment
        ...
        field :contract_type, Crystalline::Nilable.new(Models::Shared::HrisUpdateEmployeeRequestDtoContractType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('contract_type') } }
        ...
        sig { params(contract_type: T.nilable(Models::Shared::HrisUpdateEmployeeRequestDtoContractType), effective_date: T.nilable(::DateTime), employment_contract_type: T.nilable(Models::Shared::HrisUpdateEmployeeRequestDtoSchemasEmploymentContractType), employment_type: T.nilable(Models::Shared::HrisUpdateEmployeeRequestDtoSchemasEmploymentType), end_date: T.nilable(::DateTime), grade: T.nilable(Models::Shared::HrisUpdateEmployeeRequestDtoGrade), job_title: T.nilable(::String), passthrough: T.nilable(T::Hash[Symbol, ::Object]), pay_currency: T.nilable(::String), pay_frequency: T.nilable(Models::Shared::HrisUpdateEmployeeRequestDtoPayFrequency), pay_period: T.nilable(Models::Shared::HrisUpdateEmployeeRequestDtoPayPeriod), pay_rate: T.nilable(::String), payroll_code: T.nilable(::String), type: T.nilable(Models::Shared::HrisUpdateEmployeeRequestDtoType), unified_custom_fields: T.nilable(T::Hash[Symbol, ::Object]), work_time: T.nilable(Models::Shared::HrisUpdateEmployeeRequestDtoWorkTime)).void }
