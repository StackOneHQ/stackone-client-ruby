  ...
  module Models
    module Shared
      ...
      class ScheduledInterviewInterviewStatus
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::ScheduledInterviewValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::ScheduledInterviewValue, true) } }
