  ...
  module Models
    module Shared
      ...
      class AccountingTaxRate
        ...
        field :active, Crystalline::Nilable.new(Crystalline::Union.new(Crystalline::Boolean.new, Models::Shared::AccountingTaxRate2)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('active') } }
        ...
        sig { params(active: T.nilable(T.any(T::Boolean, Models::Shared::AccountingTaxRate2)), code: T.nilable(::String), company_id: T.nilable(::String), id: T.nilable(::String), name: T.nilable(::String), percentage: T.nilable(::Float), remote_id: T.nilable(::String)).void }
