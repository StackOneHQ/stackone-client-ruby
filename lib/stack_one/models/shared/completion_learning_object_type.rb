  ...
  module Models
    module Shared
      ...
      class CompletionLearningObjectType
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::CompletionValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::CompletionValue, true) } }
