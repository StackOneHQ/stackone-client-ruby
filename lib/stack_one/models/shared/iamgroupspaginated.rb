...
module StackOne
  module Shared
    ...
    class IamGroupsPaginated < ::Crystalline::FieldAugmented
      extend T::Sig


      field :data, T::Array[::StackOne::Shared::IamGroup], { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }
      ...
      sig { params(data: T::Array[::StackOne::Shared::IamGroup], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[::StackOne::Shared::RawResponse])).void }
