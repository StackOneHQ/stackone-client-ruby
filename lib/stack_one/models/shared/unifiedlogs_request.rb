...
module StackOne
  module Shared
    ...
    class UnifiedLogsRequest < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :url, T.nilable(::StackOne::Shared::UnifiedLogsUrl), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('url') } }


      sig { params(body: T.nilable(::Object), headers: T.nilable(T::Hash[Symbol, ::Object]), id: T.nilable(::String), method: T.nilable(::String), url: T.nilable(::StackOne::Shared::UnifiedLogsUrl)).void }
