...
module StackOne
  module Models
    module Shared
      ...
      # HrisDocumentsUploadRequestDtoSchemasFileFormatValue - The file format of the file, expressed as a file extension
      class HrisDocumentsUploadRequestDtoSchemasFileFormatValue < T::Enum
        enums do
