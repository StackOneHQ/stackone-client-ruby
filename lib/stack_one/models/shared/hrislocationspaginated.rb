...
module StackOne
  module Shared
    ...
    class HRISLocationsPaginated < ::Crystalline::FieldAugmented
      extend T::Sig


      field :data, T::Array[::StackOne::Shared::HRISLocation], { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }
      ...
      sig { params(data: T::Array[::StackOne::Shared::HRISLocation], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[::StackOne::Shared::RawResponse])).void }
