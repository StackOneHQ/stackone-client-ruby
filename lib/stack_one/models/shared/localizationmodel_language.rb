  ...
  module Models
    module Shared
      ...
      class LocalizationModelLanguage
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::LocalizationModelValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::LocalizationModelValue, true) } }
