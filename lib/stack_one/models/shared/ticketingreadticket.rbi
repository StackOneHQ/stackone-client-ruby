...
class StackOne::Models::Shared::TicketingReadTicket
...
class StackOne::Models::Shared::TicketingReadTicket
  def assignees(); end
  def assignees=(str_); end
  def closed_at(); end
  def closed_at=(str_); end
  def components(); end
  def components=(str_); end
  def content(); end
  ...
  def projects(); end
  def projects=(str_); end
  def remote_id(); end
  def remote_id=(str_); end
  def reporters(); end
  def reporters=(str_); end
  def status(); end
  def status=(str_); end
  def tags(); end
  def tags=(str_); end
  def ticket_number(); end
  def ticket_number=(str_); end
  def ticket_url(); end
  def ticket_url=(str_); end
  def title(); end
  def title=(str_); end
  def type(); end
  def type=(str_); end
