...
module StackOne
  module Shared
    ...
    class EmploymentsPaginated < ::Crystalline::FieldAugmented
      ...
      field :data, T::Array[::StackOne::Shared::Employment], { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }
      ...
      sig { params(data: T::Array[::StackOne::Shared::Employment], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[::StackOne::Shared::RawResponse])).void }
