  ...
  module Models
    module Shared
      ...
      class AtsJob
        ...
        # Status of the job
        field :job_status, Crystalline::Nilable.new(Models::Shared::AtsJobJobStatus), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('job_status') } }
        ...
        field :remote_department_ids, Crystalline::Nilable.new(Crystalline::Array.new(::String)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('remote_department_ids') } }
