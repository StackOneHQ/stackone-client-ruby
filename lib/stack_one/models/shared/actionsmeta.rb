  ...
  module Models
    module Shared
      ...
      class ActionsMeta
        ...
        # The list of events available for this provider
        field :event_actions, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::EventMetaItem)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('event_actions') } }
        ...
        sig { params(account_id: T.nilable(::String), actions: T.nilable(T::Array[Models::Shared::ActionMetaItem]), authentication: T.nilable(T::Array[Models::Shared::AuthenticationMetaItem]), categories: T.nilable(T::Array[::String]), connector_profile_id: T.nilable(::String), description: T.nilable(::String), event_actions: T.nilable(T::Array[Models::Shared::EventMetaItem]), icon: T.nilable(::String), integration_id: T.nilable(::String), key: T.nilable(::String), name: T.nilable(::String), release_stage: T.nilable(::String), scope_definitions: T.nilable(T::Array[Models::Shared::ScopeDefinitionMetaItem]), version: T.nilable(::String)).void }
