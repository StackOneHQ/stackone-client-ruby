  ...
  module Models
    module Shared
      ...
      class ListsPaginated
        ...
        field :data, Crystalline::Array.new(Models::Shared::List), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        sig { params(data: T::Array[Models::Shared::List], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
