  ...
  module Models
    module Shared
      ...
      class MessagingUser
        ...
        field :active, T.nilable(T.any(T::Boolean, Models::Shared::MessagingUser2)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('active') } }
        # Whether the user is a bot
        field :bot, T.nilable(T.any(T::Boolean, Models::Shared::MessagingUserSchemas2)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('bot') } }
