  ...
  module Models
    module Shared
      ...
      class BackgroundCheckResult
        ...
        field :candidate, T.nilable(Models::Shared::BackgroundCheckResultCandidate), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('candidate') } }
        # Unique identifier
        field :id, T.nilable(::String), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('id') } }
        # Provider's unique identifier
        field :remote_id, T.nilable(::String), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('remote_id') } }

        field :result, T.nilable(Models::Shared::BackgroundCheckResultResult), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('result') } }
        # The test`s result url
        field :result_url, T.nilable(::String), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('result_url') } }

        field :score, T.nilable(Models::Shared::BackgroundCheckResultScore), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('score') } }
        ...
        sig { params(attachments: T.nilable(T::Array[Models::Shared::Attachment]), candidate: T.nilable(Models::Shared::BackgroundCheckResultCandidate), id: T.nilable(::String), remote_id: T.nilable(::String), result: T.nilable(Models::Shared::BackgroundCheckResultResult), result_url: T.nilable(::String), score: T.nilable(Models::Shared::BackgroundCheckResultScore), start_date: T.nilable(::DateTime), submission_date: T.nilable(::DateTime), summary: T.nilable(::String)).void }
