  ...
  module Models
    module Shared
      ...
      class HRISCostCenter
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::HRISCostCenterType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('type') } }
