  ...
  module Models
    module Shared
      ...
      class AccountType
        ...
        # The type of bank account
        field :value, Crystalline::Nilable.new(Models::Shared::HRISBankDetailsValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::HRISBankDetailsValue, true) } }
