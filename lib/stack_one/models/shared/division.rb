...
module StackOne
  module Shared
    ...
    class Division < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      field :type, T.nilable(::StackOne::Shared::EmploymentSchemasDivisionType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('type') } }
