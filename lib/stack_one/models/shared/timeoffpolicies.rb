...
module StackOne
  module Shared
    ...
    class TimeOffPolicies < ::Crystalline::FieldAugmented
      ...
      field :duration_unit, T.nilable(::StackOne::Shared::DurationUnit), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('duration_unit') } }
      # Unique identifier
