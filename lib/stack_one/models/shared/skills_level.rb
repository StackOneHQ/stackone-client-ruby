  ...
  module Models
    module Shared
      ...
      class SkillsLevel
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::SkillsSchemasLevelValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::SkillsSchemasLevelValue, true) } }
