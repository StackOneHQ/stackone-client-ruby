  ...
  module Models
    module Shared
      ...
      class WorkLocation
        ...
        # The country code
        field :country, T.nilable(Models::Shared::EmployeeSchemasWorkLocationCountry), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('country') } }
        # The created_at date
        ...
        # The location type
        field :location_type, T.nilable(Models::Shared::EmployeeSchemasLocationType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('location_type') } }
        ...
        sig { params(city: T.nilable(::String), country: T.nilable(Models::Shared::EmployeeSchemasWorkLocationCountry), created_at: T.nilable(::DateTime), employee_id: T.nilable(::String), id: T.nilable(::String), location_type: T.nilable(Models::Shared::EmployeeSchemasLocationType), name: T.nilable(::String), phone_number: T.nilable(::String), remote_employee_id: T.nilable(::String), remote_id: T.nilable(::String), state: T.nilable(::String), street_1: T.nilable(::String), street_2: T.nilable(::String), unified_custom_fields: T.nilable(T::Hash[Symbol, ::Object]), updated_at: T.nilable(::DateTime), zip_code: T.nilable(::String)).void }
