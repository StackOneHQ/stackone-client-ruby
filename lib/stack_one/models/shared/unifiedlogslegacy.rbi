...
class StackOne::Models::Shared::UnifiedLogsLegacy
...
class StackOne::Models::Shared::UnifiedLogsLegacy
  ...
  def event_datetime(); end
  def event_datetime=(str_); end
  def http_method(); end
  ...
  def status(); end
  def status=(str_); end
  def step_requests(); end
  def step_requests=(str_); end
