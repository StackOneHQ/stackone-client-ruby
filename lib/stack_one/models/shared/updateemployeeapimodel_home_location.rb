...
module StackOne
  module Shared
    ...
    class UpdateEmployeeApiModelHomeLocation < ::StackOne::Utils::FieldAugmented
      extend T::Sig

      # The city where the location is situated
      field :city, T.nilable(::String), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('city') } }
      # The country code
      field :country, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelCountry), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('country') } }
      # Unique identifier
      ...
      field :state, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelState), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('state') } }
      ...
      sig { params(city: T.nilable(::String), country: T.nilable(::StackOne::Shared::UpdateEmployeeApiModelCountry), id: T.nilable(::String), name: T.nilable(::String), passthrough: T.nilable(T::Hash[Symbol, ::Object]), phone_number: T.nilable(::String), state: T.nilable(::StackOne::Shared::UpdateEmployeeApiModelState), street_1: T.nilable(::String), street_2: T.nilable(::String), zip_code: T.nilable(::String)).void }
