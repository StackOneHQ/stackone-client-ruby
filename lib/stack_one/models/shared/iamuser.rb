  ...
  module Models
    module Shared
      ...
      class IamUser
        ...
        field :groups, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::IamGroup)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('groups') } }
        # Unique identifier
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::IamUserStatus), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('status') } }
