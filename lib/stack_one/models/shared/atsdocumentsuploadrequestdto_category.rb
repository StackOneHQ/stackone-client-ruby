  ...
  module Models
    module Shared
      ...
      class AtsDocumentsUploadRequestDtoCategory
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::AtsDocumentsUploadRequestDtoValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::AtsDocumentsUploadRequestDtoValue, true) } }
