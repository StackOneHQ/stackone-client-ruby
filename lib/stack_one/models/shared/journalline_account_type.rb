  ...
  module Models
    module Shared
      ...
      class JournalLineAccountType
        ...
        # Type of account
        field :value, Crystalline::Nilable.new(Models::Shared::JournalLineValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::JournalLineValue, true) } }
