  ...
  module Models
    module Shared
      ...
      class CountryCode
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::HRISBankDetailsSchemasValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::HRISBankDetailsSchemasValue, true) } }
