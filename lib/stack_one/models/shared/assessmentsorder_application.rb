...
module StackOne
  module Shared
    ...
    class AssessmentsOrderApplication < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(application_status: T.nilable(::StackOne::Shared::AssessmentsOrderApplicationStatus), id: T.nilable(::String), passthrough: T.nilable(T::Hash[Symbol, ::Object]), remote_id: T.nilable(::String)).void }
