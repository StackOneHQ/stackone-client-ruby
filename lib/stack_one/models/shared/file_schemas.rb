  ...
  module Models
    module Shared
      ...
      class FileSchemas
        ...
        field :category, Crystalline::Nilable.new(Models::Shared::SchemasCategory), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('category') } }
        ...
        sig { params(category: T.nilable(Models::Shared::SchemasCategory), category_id: T.nilable(::String), contents: T.nilable(T::Array[Models::Shared::Content]), created_at: T.nilable(::DateTime), file_format: T.nilable(Models::Shared::FileFormat), id: T.nilable(::String), name: T.nilable(::String), remote_id: T.nilable(::String), remote_url: T.nilable(::String), updated_at: T.nilable(::DateTime)).void }
