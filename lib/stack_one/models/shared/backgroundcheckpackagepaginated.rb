  ...
  module Models
    module Shared
      ...
      class BackgroundCheckPackagePaginated
        ...
        field :data, Crystalline::Array.new(Models::Shared::BackgroundCheckPackage), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        sig { params(data: T::Array[Models::Shared::BackgroundCheckPackage], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
