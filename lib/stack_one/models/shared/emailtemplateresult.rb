...
module StackOne
  module Shared
    ...
    class EmailTemplateResult < ::StackOne::Utils::FieldAugmented
      ...
      field :data, ::StackOne::Shared::EmailTemplate, { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }

      field :raw, T.nilable(T::Array[::StackOne::Shared::RawResponse]), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('raw') } }


      sig { params(data: ::StackOne::Shared::EmailTemplate, raw: T.nilable(T::Array[::StackOne::Shared::RawResponse])).void }
