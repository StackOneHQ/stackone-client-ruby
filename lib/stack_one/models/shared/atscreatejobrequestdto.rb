  ...
  module Models
    module Shared
      ...
      class AtsCreateJobRequestDto
        ...
        field :confidential, Crystalline::Nilable.new(Models::Shared::Confidential), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('confidential'), 'decoder': Utils.enum_from_string(Models::Shared::Confidential, true) } }
