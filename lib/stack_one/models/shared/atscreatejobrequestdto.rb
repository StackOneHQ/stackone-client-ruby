  ...
  module Models
    module Shared
      ...
      class AtsCreateJobRequestDto
        ...
        field :confidential, Crystalline::Nilable.new(Models::Shared::Confidential), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('confidential'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::Confidential, true) } }
        ...
        # Status of the job
        field :job_status, Crystalline::Nilable.new(Models::Shared::JobStatus), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('job_status') } }
        ...
        sig { params(code: T.nilable(::String), confidential: T.nilable(Models::Shared::Confidential), custom_fields: T.nilable(T::Array[Models::Shared::CustomFields]), department_ids: T.nilable(T::Array[::String]), description: T.nilable(::String), hiring_team: T.nilable(T::Array[Models::Shared::AtsJobHiringTeam]), interview_stages: T.nilable(T::Array[Models::Shared::InterviewStage]), job_status: T.nilable(Models::Shared::JobStatus), location_ids: T.nilable(T::Array[::String]), passthrough: T.nilable(T::Hash[Symbol, ::Object]), status: T.nilable(::String), title: T.nilable(::String), unified_custom_fields: T.nilable(T::Hash[Symbol, ::Object])).void }
