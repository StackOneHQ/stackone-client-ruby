  ...
  module Models
    module Shared
      ...
      class HrisUpdateEmployeeRequestDtoHomeLocation
        ...
        # The country code
        field :country, Crystalline::Nilable.new(Models::Shared::HrisUpdateEmployeeRequestDtoCountry), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('country') } }
        # Unique identifier
        ...
        field :state, Crystalline::Nilable.new(Models::Shared::HrisUpdateEmployeeRequestDtoState), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('state') } }
