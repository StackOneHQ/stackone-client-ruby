  ...
  module Models
    module Shared
      ...
      class AccountingCompany
        ...
        field :base_currency, Crystalline::Nilable.new(Models::Shared::BaseCurrency), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('base_currency') } }
        ...
        sig { params(base_currency: T.nilable(Models::Shared::BaseCurrency), fiscal_year_start_day: T.nilable(::Float), fiscal_year_start_month: T.nilable(::Float), id: T.nilable(::String), name: T.nilable(::String), remote_id: T.nilable(::String)).void }
