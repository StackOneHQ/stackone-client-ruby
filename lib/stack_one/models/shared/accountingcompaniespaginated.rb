  ...
  module Models
    module Shared
      ...
      class AccountingCompaniesPaginated
        ...
        field :data, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::AccountingCompany)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }
        ...
        sig { params(data: T.nilable(T::Array[Models::Shared::AccountingCompany]), next_: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
