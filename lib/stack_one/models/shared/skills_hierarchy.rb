  ...
  module Models
    module Shared
      ...
      class SkillsHierarchy
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::SkillsValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::SkillsValue, true) } }
