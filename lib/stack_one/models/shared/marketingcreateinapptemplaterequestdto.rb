...
module StackOne
  module Shared
    ...
    class MarketingCreateInAppTemplateRequestDto < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(messages: T.nilable(T::Array[::StackOne::Shared::InAppMessages]), name: T.nilable(::String), passthrough: T.nilable(T::Hash[Symbol, ::Object]), tags: T.nilable(T::Array[::String])).void }
