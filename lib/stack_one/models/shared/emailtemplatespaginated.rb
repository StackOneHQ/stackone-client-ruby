  ...
  module Models
    module Shared
      ...
      class EmailTemplatesPaginated
        ...
        field :data, Crystalline::Array.new(Models::Shared::EmailTemplate), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        sig { params(data: T::Array[Models::Shared::EmailTemplate], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
