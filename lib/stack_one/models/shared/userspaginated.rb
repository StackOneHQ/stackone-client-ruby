  ...
  module Models
    module Shared
      ...
      class UsersPaginated
        ...
        field :data, Crystalline::Array.new(Models::Shared::LmsUser), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        sig { params(data: T::Array[Models::Shared::LmsUser], next_: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
