...
module StackOne
  module Shared
    ...
    class UpdateEmployeeApiModel < ::StackOne::Utils::FieldAugmented
      extend T::Sig

      # The employee avatar
      field :avatar, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelAvatar), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('avatar') } }
      ...
      field :employment_status, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelEmploymentStatus), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('employment_status') } }
      # The employee employment type
      field :employment_type, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelEmploymentType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('employment_type') } }
      ...
      field :ethnicity, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelEthnicity), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('ethnicity') } }
      # The employee first name
      field :first_name, T.nilable(::String), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('first_name') } }
      # The employee gender
      field :gender, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelGender), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('gender') } }
      ...
      field :home_location, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelHomeLocation), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('home_location') } }
      # The employee job id
      ...
      field :marital_status, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelMaritalStatus), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('marital_status') } }
      # The employee name
      field :name, T.nilable(::String), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('name') } }
      # The national identity number
      field :national_identity_number, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelNationalIdentityNumber), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('national_identity_number') } }
