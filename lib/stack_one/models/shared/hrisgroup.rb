  ...
  module Models
    module Shared
      ...
      class HRISGroup
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::HRISGroupType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('type') } }
