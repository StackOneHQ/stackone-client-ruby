  ...
  module Models
    module Shared
      ...
      class HomeLocation
        ...
        # The country code
        field :country, Crystalline::Nilable.new(Models::Shared::EmployeeCountry), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('country') } }
        # The created_at date
        ...
        # The location type
        field :location_type, Crystalline::Nilable.new(Models::Shared::EmployeeLocationType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('location_type') } }
        ...
        sig { params(city: T.nilable(::String), country: T.nilable(Models::Shared::EmployeeCountry), created_at: T.nilable(::DateTime), employee_id: T.nilable(::String), id: T.nilable(::String), location_type: T.nilable(Models::Shared::EmployeeLocationType), name: T.nilable(::String), phone_number: T.nilable(::String), remote_employee_id: T.nilable(::String), remote_id: T.nilable(::String), state: T.nilable(::String), street_1: T.nilable(::String), street_2: T.nilable(::String), unified_custom_fields: T.nilable(T::Hash[Symbol, ::Object]), updated_at: T.nilable(::DateTime), zip_code: T.nilable(::String)).void }
