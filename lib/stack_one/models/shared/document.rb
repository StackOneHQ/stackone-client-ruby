  ...
  module Models
    module Shared
      ...
      class Document
        ...
        field :category, T.nilable(Models::Shared::HrisCreateWorkEligibilityRequestDtoCategory), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('category') } }
        ...
        field :file_format, T.nilable(Models::Shared::HrisCreateWorkEligibilityRequestDtoFileFormat), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('file_format') } }
        # Unique identifier
