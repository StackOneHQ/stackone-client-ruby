  ...
  module Models
    module Shared
      ...
      class MarketingCreateTemplateRequestDto
        ...
        field :messages, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::CreateMessage)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('messages') } }
        ...
        sig { params(messages: T.nilable(T::Array[Models::Shared::CreateMessage]), name: T.nilable(::String), passthrough: T.nilable(T::Hash[Symbol, ::Object]), tags: T.nilable(T::Array[::String])).void }
