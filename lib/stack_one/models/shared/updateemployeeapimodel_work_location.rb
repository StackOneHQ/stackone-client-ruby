...
module StackOne
  module Shared
    ...
    class UpdateEmployeeApiModelWorkLocation < ::Crystalline::FieldAugmented
      ...
      # The country code
      field :country, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelSchemasWorkLocationCountry), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('country') } }
      # Unique identifier
      ...
      field :state, T.nilable(::StackOne::Shared::UpdateEmployeeApiModelSchemasState), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('state') } }
