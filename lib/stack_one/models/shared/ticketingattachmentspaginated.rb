  ...
  module Models
    module Shared
      ...
      class TicketingAttachmentsPaginated
        ...
        field :data, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::TicketingAttachment)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }
        ...
        sig { params(data: T.nilable(T::Array[Models::Shared::TicketingAttachment]), next_: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
