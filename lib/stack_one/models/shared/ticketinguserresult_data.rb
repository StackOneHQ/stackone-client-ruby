  ...
  module Models
    module Shared
      ...
      class TicketingUserResultData
        ...
        field :active, Crystalline::Nilable.new(Crystalline::Union.new(Crystalline::Boolean.new, Models::Shared::TicketingUserResult2)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('active') } }
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::TicketingUserResultType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('type') } }
        ...
        sig { params(active: T.nilable(T.any(T::Boolean, Models::Shared::TicketingUserResult2)), created_at: T.nilable(::DateTime), customer_account_reference: T.nilable(::String), first_name: T.nilable(::String), id: T.nilable(::String), last_name: T.nilable(::String), name: T.nilable(::String), primary_email: T.nilable(::String), primary_phone: T.nilable(::String), remote_id: T.nilable(::String), type: T.nilable(Models::Shared::TicketingUserResultType), updated_at: T.nilable(::DateTime), username: T.nilable(::String)).void }
