  ...
  module Models
    module Shared
      ...
      class SkillsLanguage
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::SkillsSchemasValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::SkillsSchemasValue, true) } }
