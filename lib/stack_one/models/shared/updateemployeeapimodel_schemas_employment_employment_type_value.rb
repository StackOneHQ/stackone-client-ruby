...
module StackOne
  module Shared
    ...
    # UpdateEmployeeApiModelSchemasEmploymentEmploymentTypeValue - The type of the employment.
    class UpdateEmployeeApiModelSchemasEmploymentEmploymentTypeValue < T::Enum
      enums do
