  ...
  module Models
    module Shared
      ...
      class TicketingCommentResultData
        ...
        field :internal, Crystalline::Nilable.new(Crystalline::Union.new(Crystalline::Boolean.new, Models::Shared::TicketingCommentResult2)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('internal') } }
        ...
        sig { params(ticket_id: ::String, content: T.nilable(T::Array[Models::Shared::TicketingContent]), created_at: T.nilable(::DateTime), id: T.nilable(::String), internal: T.nilable(T.any(T::Boolean, Models::Shared::TicketingCommentResult2)), remote_id: T.nilable(::String), updated_at: T.nilable(::DateTime), user_id: T.nilable(::String)).void }
