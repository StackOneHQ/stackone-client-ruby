  ...
  module Models
    module Shared
      ...
      class TemplatesPaginated
        ...
        field :data, Crystalline::Array.new(Models::Shared::Template), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        sig { params(data: T::Array[Models::Shared::Template], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
