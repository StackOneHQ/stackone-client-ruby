  ...
  module Models
    module Shared
      ...
      class LanguageEnum
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::LanguageEnumValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::LanguageEnumValue, true) } }
