...
module StackOne
  module Shared
    ...
    class TimeOffPaginated < ::Crystalline::FieldAugmented
      ...
      field :data, T::Array[::StackOne::Shared::TimeOff], { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }
      ...
      sig { params(data: T::Array[::StackOne::Shared::TimeOff], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[::StackOne::Shared::RawResponse])).void }
