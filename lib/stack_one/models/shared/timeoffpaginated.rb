  ...
  module Models
    module Shared
      ...
      class TimeOffPaginated
        ...
        field :data, Crystalline::Array.new(Models::Shared::TimeOff), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        sig { params(data: T::Array[Models::Shared::TimeOff], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
