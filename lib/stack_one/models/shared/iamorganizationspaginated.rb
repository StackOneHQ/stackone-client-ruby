...
module StackOne
  module Models
    module Shared
      ...
      class IamOrganizationsPaginated
        extend T::Sig
        include Crystalline::MetadataFields


        field :data, Crystalline::Array.new(Models::Shared::IamOrganization), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        sig { params(data: T::Array[Models::Shared::IamOrganization], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
