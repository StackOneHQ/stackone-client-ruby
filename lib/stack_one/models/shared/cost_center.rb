  ...
  module Models
    module Shared
      ...
      class CostCenter
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::EmploymentSchemasCostCenterType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('type') } }
