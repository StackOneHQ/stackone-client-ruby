  ...
  module Models
    module Shared
      ...
      class HrisUpdateEmploymentRequestDto
        ...
        field :contract_type, Crystalline::Nilable.new(Models::Shared::HrisUpdateEmploymentRequestDtoContractType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('contract_type') } }
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::HrisUpdateEmploymentRequestDtoType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('type') } }
        ...
        sig { params(contract_type: T.nilable(Models::Shared::HrisUpdateEmploymentRequestDtoContractType), effective_date: T.nilable(::DateTime), employment_contract_type: T.nilable(Models::Shared::HrisUpdateEmploymentRequestDtoEmploymentContractType), employment_type: T.nilable(Models::Shared::HrisUpdateEmploymentRequestDtoEmploymentType), end_date: T.nilable(::DateTime), grade: T.nilable(Models::Shared::HrisUpdateEmploymentRequestDtoGrade), job_title: T.nilable(::String), passthrough: T.nilable(T::Hash[Symbol, ::Object]), pay_currency: T.nilable(::String), pay_frequency: T.nilable(Models::Shared::HrisUpdateEmploymentRequestDtoPayFrequency), pay_period: T.nilable(Models::Shared::HrisUpdateEmploymentRequestDtoPayPeriod), pay_rate: T.nilable(::String), payroll_code: T.nilable(::String), type: T.nilable(Models::Shared::HrisUpdateEmploymentRequestDtoType), unified_custom_fields: T.nilable(T::Hash[Symbol, ::Object]), work_time: T.nilable(Models::Shared::HrisUpdateEmploymentRequestDtoWorkTime)).void }
