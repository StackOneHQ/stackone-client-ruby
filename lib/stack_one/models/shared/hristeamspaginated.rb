  ...
  module Models
    module Shared
      ...
      class HRISTeamsPaginated
        ...
        field :data, Crystalline::Array.new(Models::Shared::HRISTeam), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        sig { params(data: T::Array[Models::Shared::HRISTeam], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
