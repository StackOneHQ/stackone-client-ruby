...
module StackOne
  module Shared
    ...
    class CompanyResult < ::Crystalline::FieldAugmented
      ...
      field :data, ::StackOne::Shared::Company, { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }

      field :raw, T.nilable(T::Array[::StackOne::Shared::RawResponse]), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('raw') } }


      sig { params(data: ::StackOne::Shared::Company, raw: T.nilable(T::Array[::StackOne::Shared::RawResponse])).void }
