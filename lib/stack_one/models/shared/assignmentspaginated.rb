  ...
  module Models
    module Shared
      ...
      class AssignmentsPaginated
        ...
        field :data, Crystalline::Array.new(Models::Shared::Assignment), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        sig { params(data: T::Array[Models::Shared::Assignment], next_: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
