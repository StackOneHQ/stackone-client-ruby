  ...
  module Models
    module Shared
      ...
      class BackgroundCheckOrderPaginated
        ...
        field :data, T::Array[Models::Shared::BackgroundCheckOrder], { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }
        ...
        sig { params(data: T::Array[Models::Shared::BackgroundCheckOrder], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
