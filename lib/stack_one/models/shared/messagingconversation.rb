  ...
  module Models
    module Shared
      ...
      class MessagingConversation
        ...
        field :private, Crystalline::Nilable.new(Crystalline::Union.new(Crystalline::Boolean.new, Models::Shared::MessagingConversation2)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('private') } }
        # Provider's unique identifier
        field :remote_id, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('remote_id') } }

        sig { params(created_at: T.nilable(::DateTime), id: T.nilable(::String), last_message_at: T.nilable(::DateTime), name: T.nilable(::String), participants: T.nilable(T::Array[::String]), private: T.nilable(T.any(T::Boolean, Models::Shared::MessagingConversation2)), remote_id: T.nilable(::String)).void }
