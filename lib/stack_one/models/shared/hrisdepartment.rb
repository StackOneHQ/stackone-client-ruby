  ...
  module Models
    module Shared
      ...
      class HRISDepartment
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::HRISDepartmentType), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('type') } }
