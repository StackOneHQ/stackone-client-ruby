  ...
  module Models
    module Shared
      ...
      class ContentPaginated
        ...
        field :data, Crystalline::Array.new(Models::Shared::Content), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data'), required: true } }
        ...
        def initialize(data:, next_: nil, next_page: nil, raw: nil, total: nil)
          @data = data
          @next_ = next_
          @next_page = next_page
          @raw = raw
