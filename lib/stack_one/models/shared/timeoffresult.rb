...
module StackOne
  module Shared
    ...
    class TimeOffResult < ::Crystalline::FieldAugmented
      ...
      field :data, ::StackOne::Shared::TimeOff, { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }

      field :raw, T.nilable(T::Array[::StackOne::Shared::RawResponse]), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('raw') } }


      sig { params(data: ::StackOne::Shared::TimeOff, raw: T.nilable(T::Array[::StackOne::Shared::RawResponse])).void }
