  ...
  module Models
    module Shared
      ...
      class EmploymentWorkTime
        ...
        field :period, Crystalline::Nilable.new(Models::Shared::EmploymentPeriod), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('period') } }

        sig { params(duration: T.nilable(::String), period: T.nilable(Models::Shared::EmploymentPeriod)).void }
