...
module StackOne
  module Shared
    ...
    # HrisCreateWorkEligibilityRequestDtoSchemasDocumentValue - The file format of the file, expressed as a file extension
    class HrisCreateWorkEligibilityRequestDtoSchemasDocumentValue < T::Enum
      enums do
