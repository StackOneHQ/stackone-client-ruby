  ...
  module Models
    module Shared
      ...
      class UnifiedLogsLegacy
        ...
        field :event_datetime, Crystalline::Nilable.new(::DateTime), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('event_datetime'), 'decoder': ::StackOne::Utils.datetime_from_iso_format(true) } }
        ...
        field :response, Crystalline::Nilable.new(Models::Shared::UnifiedLogsLegacyResponse), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('response') } }
        ...
        field :step_requests, Crystalline::Nilable.new(Crystalline::Array.new(Models::Shared::StepLog)), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('step_requests') } }
        ...
        sig { params(account_id: T.nilable(::String), action: T.nilable(::String), child_resource: T.nilable(::String), duration: T.nilable(::Float), end_time: T.nilable(::DateTime), event_datetime: T.nilable(::DateTime), http_method: T.nilable(::String), is_worker: T.nilable(T::Boolean), path: T.nilable(::String), project_id: T.nilable(::String), provider: T.nilable(::String), request: T.nilable(Models::Shared::Request), request_id: T.nilable(::String), resource: T.nilable(::String), response: T.nilable(Models::Shared::UnifiedLogsLegacyResponse), service: T.nilable(::String), source_id: T.nilable(::String), source_ip: T.nilable(::String), source_type: T.nilable(::String), source_value: T.nilable(::String), start_time: T.nilable(::DateTime), status: T.nilable(::Float), step_requests: T.nilable(T::Array[Models::Shared::StepLog]), sub_resource: T.nilable(::String), success: T.nilable(T::Boolean), url: T.nilable(::String)).void }
