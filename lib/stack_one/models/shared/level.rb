  ...
  module Models
    module Shared
      ...
      class Level
        ...
        field :value, Crystalline::Nilable.new(Models::Shared::CategorySchemasLevelValue), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('value'), 'decoder': ::StackOne::Utils.open_enum_from_string(Models::Shared::CategorySchemasLevelValue, true) } }
