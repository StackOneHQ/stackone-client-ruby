  ...
  module Models
    module Shared
      ...
      class HRISCostCenterPaginated
        ...
        field :data, T::Array[Models::Shared::HRISCostCenter], { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('data') } }
        ...
        sig { params(data: T::Array[Models::Shared::HRISCostCenter], next_: T.nilable(::String), next_page: T.nilable(::String), raw: T.nilable(T::Array[Models::Shared::RawResponse])).void }
