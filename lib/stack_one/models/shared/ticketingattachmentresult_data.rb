  ...
  module Models
    module Shared
      ...
      class TicketingAttachmentResultData
        ...
        field :file_format, T.nilable(Models::Shared::TicketingAttachmentResultFileFormat), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('file_format') } }
        ...
        sig { params(created_at: T.nilable(::DateTime), file_format: T.nilable(Models::Shared::TicketingAttachmentResultFileFormat), file_name: T.nilable(::String), file_url: T.nilable(::String), id: T.nilable(::String), remote_id: T.nilable(::String), size: T.nilable(::Float), ticket_id: T.nilable(::String), updated_at: T.nilable(::DateTime), user_id: T.nilable(::String)).void }
