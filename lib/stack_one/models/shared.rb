...
module StackOne
  module Shared
    autoload :UnprocessableEntityResponse, 'stack_one/models/shared/unprocessableentityresponse.rb'
    autoload :UnauthorizedResponse, 'stack_one/models/shared/unauthorizedresponse.rb'
    autoload :TooManyRequestsResponse, 'stack_one/models/shared/toomanyrequestsresponse.rb'
    autoload :RequestTimedOutResponse, 'stack_one/models/shared/requesttimedoutresponse.rb'
    autoload :NotImplementedResponse, 'stack_one/models/shared/notimplementedresponse.rb'
    autoload :NotFoundResponse, 'stack_one/models/shared/notfoundresponse.rb'
    ...
    autoload :InternalServerErrorResponse, 'stack_one/models/shared/internalservererrorresponse.rb'
    autoload :ForbiddenResponse, 'stack_one/models/shared/forbiddenresponse.rb'
    autoload :ConflictResponse, 'stack_one/models/shared/conflictresponse.rb'
    autoload :BadRequestResponseHeaders, 'stack_one/models/shared/badrequestresponse_headers.rb'
    autoload :Data, 'stack_one/models/shared/data.rb'
    autoload :BadRequestResponse, 'stack_one/models/shared/badrequestresponse.rb'
    ...
    autoload :BadGatewayResponse, 'stack_one/models/shared/badgatewayresponse.rb'
    ...
    autoload :PreconditionFailedResponse, 'stack_one/models/shared/preconditionfailedresponse.rb'
