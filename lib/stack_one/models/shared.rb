...
module StackOne
  module Shared
    ...
    autoload :CreateAssessmentsPackages, 'stack_one/models/shared/createassessmentspackages.rb'
    ...
    autoload :AssessmentsOrderResult, 'stack_one/models/shared/assessmentsorderresult.rb'
    autoload :AssessmentsOrderValue, 'stack_one/models/shared/assessmentsorder_value.rb'
    autoload :AssessmentsOrderApplicationStatus, 'stack_one/models/shared/assessmentsorder_application_status.rb'
    autoload :AssessmentsOrderApplication, 'stack_one/models/shared/assessmentsorder_application.rb'
    autoload :AssessmentsOrderCandidate, 'stack_one/models/shared/assessmentsorder_candidate.rb'
    autoload :AssessmentsOrderJob, 'stack_one/models/shared/assessmentsorder_job.rb'
    autoload :Package, 'stack_one/models/shared/package.rb'
    autoload :Requester, 'stack_one/models/shared/requester.rb'
    autoload :AssessmentsOrder, 'stack_one/models/shared/assessmentsorder.rb'
    autoload :AssessmentsRequestsJobHiringTeamApiModel, 'stack_one/models/shared/assessmentsrequestsjobhiringteamapimodel.rb'
    ...
    autoload :AssessmentsAttachmentValue, 'stack_one/models/shared/assessmentsattachment_value.rb'
    autoload :AssessmentsAttachmentContentType, 'stack_one/models/shared/assessmentsattachment_content_type.rb'
    autoload :AssessmentsAttachment, 'stack_one/models/shared/assessmentsattachment.rb'
    ...
    autoload :AssessmentsPackagesTestApiModel, 'stack_one/models/shared/assessmentspackagestestapimodel.rb'
    autoload :BackgroundCheckResultsResultCandidate, 'stack_one/models/shared/backgroundcheckresultsresult_candidate.rb'
    autoload :BackgroundCheckResultsResultValue, 'stack_one/models/shared/backgroundcheckresultsresult_value.rb'
    autoload :BackgroundCheckResultsResultResult, 'stack_one/models/shared/backgroundcheckresultsresult_result.rb'
    autoload :BackgroundCheckResultsResultScore, 'stack_one/models/shared/backgroundcheckresultsresult_score.rb'
