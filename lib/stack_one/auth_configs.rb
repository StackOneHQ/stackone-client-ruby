...
module StackOne
  ...
  class AuthConfigs
    ...
    def list_auth_configs(connector_key: nil, enabled: nil, page: nil, page_size: nil, retries: nil, timeout_ms: nil, http_headers: nil)
      ...
      url = "#{base_url}/auth_configs"
      headers = {}
      headers = T.cast(headers, T::Hash[String, String])
      query_params = Utils.get_query_params(Models::Operations::StackoneListAuthConfigsRequest, request, nil)
      ...
      hook_ctx = SDKHooks::HookContext.new(
        ...
        base_url: base_url,
        oauth2_scopes: nil,
        operation_id: 'stackone_list_auth_configs',
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Shared::AuthConfigsPaginated)
          response = Models::Operations::StackoneListAuthConfigsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            headers: {},
            auth_configs_paginated: T.unsafe(obj)
          )
