...
require 'faraday'
require_relative '../shared/listresult'
...
module StackOne
  module Operations
    ...
    class CrmGetListResponse < StackOne::Utils::FieldAugmented
      ...
      field :list_result, T.nilable(Shared::ListResult)


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, list_result: T.nilable(Shared::ListResult)).void }
