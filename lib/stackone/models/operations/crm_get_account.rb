...
require 'faraday'
require_relative '../shared/accountresult'
...
module StackOne
  module Operations
    ...
    class CrmGetAccountResponse < StackOne::Utils::FieldAugmented
      extend T::Sig
      ...
      field :account_result, T.nilable(Shared::AccountResult)


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, account_result: T.nilable(Shared::AccountResult)).void }
