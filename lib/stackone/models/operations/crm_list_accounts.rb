...
require 'faraday'
require_relative '../shared/accountspaginated'
...
module StackOne
  module Operations
    ...
    class CrmListAccountsResponse < StackOne::Utils::FieldAugmented
      ...
      field :accounts_paginated, T.nilable(Shared::AccountsPaginated)


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, accounts_paginated: T.nilable(Shared::AccountsPaginated)).void }
