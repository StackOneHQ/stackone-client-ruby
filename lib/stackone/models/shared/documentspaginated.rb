...
module StackOne
  module Shared
    ...
    class DocumentsPaginated < StackOne::Utils::FieldAugmented
      ...
      field :data, T::Array[Shared::DocumentApiModel], { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('data') } }
      ...
      sig { params(data: T::Array[Shared::DocumentApiModel], next_: T.nilable(String), next_page: T.nilable(String), raw: T.nilable(T::Array[Shared::RawResponse])).void }
