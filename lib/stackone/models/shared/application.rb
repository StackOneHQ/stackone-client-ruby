...
module StackOne
  module Shared
    ...
    class ApplicationQuestionnaire < StackOne::Utils::FieldAugmented
      extend T::Sig
    ...
    class Application < StackOne::Utils::FieldAugmented
      ...
      # Questionnaire associated with the application
      field :questionnaire, Shared::ApplicationQuestionnaire, { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('questionnaire') } }
      ...
      field :interview_stage_id, T.nilable(String), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('interview_stage_id') } }
      # Unique identifier of the job
      field :job_id, T.nilable(String), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('job_id') } }
      # Unique identifier of the location
      field :location_id, T.nilable(String), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('location_id') } }
      ...
      field :rejected_reason_ids, T.nilable(T::Array[String]), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('rejected_reason_ids') } }

      field :rejected_reasons, T.nilable(T::Array[Shared::RejectedReason]), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('rejected_reasons') } }

      field :result_links, T.nilable(T::Array[Shared::ResultLink]), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('result_links') } }
      # Date of last update
      field :updated_at, T.nilable(DateTime), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('updated_at'), 'decoder': Utils.datetime_from_iso_format(true) } }


      sig { params(application_status: Shared::ApplicationStatusEnumApiModel, candidate: Shared::ApplicationCandidate, questionnaire: Shared::ApplicationQuestionnaire, attachments: T.nilable(T::Array[Shared::ApplicationAttachment]), candidate_id: T.nilable(String), created_at: T.nilable(DateTime), id: T.nilable(String), interview_stage: T.nilable(T::Array[Shared::InterviewStage]), interview_stage_id: T.nilable(String), job_id: T.nilable(String), location_id: T.nilable(String), location_ids: T.nilable(T::Array[String]), rejected_at: T.nilable(DateTime), rejected_reason_ids: T.nilable(T::Array[String]), rejected_reasons: T.nilable(T::Array[Shared::RejectedReason]), result_links: T.nilable(T::Array[Shared::ResultLink]), updated_at: T.nilable(DateTime)).void }
      def initialize(application_status: nil, candidate: nil, questionnaire: nil, attachments: nil, candidate_id: nil, created_at: nil, id: nil, interview_stage: nil, interview_stage_id: nil, job_id: nil, location_id: nil, location_ids: nil, rejected_at: nil, rejected_reason_ids: nil, rejected_reasons: nil, result_links: nil, updated_at: nil)
