...
module StackOne
  module Shared
    ...
    class EmploymentType < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(source_value: T.nilable(String), value: T.nilable(Shared::EmployeeSchemasEmploymentTypeValue)).void }
      def initialize(source_value: nil, value: nil)
        @source_value = source_value
        @value = value
      end
    ...
    class Employee < ::StackOne::Utils::FieldAugmented
      ...
      field :cost_center, T.nilable(String), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('cost_center') } }
      # The created_at date
      field :created_at, T.nilable(DateTime), { 'format_json': { 'letter_case': ::StackOne::Utils.field_name('created_at'), 'decoder': Utils.datetime_from_iso_format(true) } }
