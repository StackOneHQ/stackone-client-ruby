...
module StackOne
  module Shared
    ...
    class DocumentTypeEnum < StackOne::Utils::FieldAugmented
      ...
      field :value, Shared::DocumentTypeEnumValue, { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('value'), 'decoder': Utils.enum_from_string(Shared::DocumentTypeEnumValue, false) } }
