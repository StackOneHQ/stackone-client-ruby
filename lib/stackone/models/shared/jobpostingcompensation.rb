...
module StackOne
  module Shared
    ...
    class JobPostingCompensationPayFrequency < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(source_value: T.nilable(String), value: T.nilable(Shared::JobPostingCompensationValue)).void }
    ...
    class JobPostingCompensationPayPeriod < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(source_value: T.nilable(String), value: T.nilable(Shared::JobPostingCompensationSchemasValue)).void }
      def initialize(source_value: nil, value: nil)
        @source_value = source_value
        @value = value
      end
    ...
    class JobPostingCompensationType < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(source_value: T.nilable(String), value: T.nilable(Shared::JobPostingCompensationSchemasTypeValue)).void }
      def initialize(source_value: nil, value: nil)
        @source_value = source_value
        @value = value
      end
