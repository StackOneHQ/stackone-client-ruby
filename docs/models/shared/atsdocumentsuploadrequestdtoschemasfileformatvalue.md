...
value = AtsDocumentsUploadRequestDtoSchemasFileFormatValue::UNMAPPED_VALUE

# Open enum: use .deserialize() to create instances from custom string values
custom = AtsDocumentsUploadRequestDtoSchemasFileFormatValue.deserialize("custom_value")
```
