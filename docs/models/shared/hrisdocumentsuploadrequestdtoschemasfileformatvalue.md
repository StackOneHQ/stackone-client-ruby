...
value = HrisDocumentsUploadRequestDtoSchemasFileFormatValue::UNMAPPED_VALUE

# Open enum: use .deserialize() to create instances from custom string values
custom = HrisDocumentsUploadRequestDtoSchemasFileFormatValue.deserialize("custom_value")
```
