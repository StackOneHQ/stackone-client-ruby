...
value = HrisCreateWorkEligibilityRequestDtoSchemasDocumentValue::UNMAPPED_VALUE

# Open enum: use .deserialize() to create instances from custom string values
custom = HrisCreateWorkEligibilityRequestDtoSchemasDocumentValue.deserialize("custom_value")
```
